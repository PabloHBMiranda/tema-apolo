...
class Class_Widget_Apolo_Motos extends \WP_Widget {
    ...
    public function form($instance) {
        ...
        <input class="widefat" id="<?= $widget_number_motos ?>" name="<?= $widget_number_motos . '[]'?>" type="number" value="<?= $value_number_motos ?>">
    ...
    public function update($new_instance, $old_instance) {
        $instance = array();
        $instance['widget_number_motos'] = (!empty($new_instance['widget_number_motos'])) ? $new_instance['widget_number_motos'] : 2;
